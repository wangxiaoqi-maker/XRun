...
// 用例: 转账
// 平台: iOS
// 生成时间: 2026-02-05T18:01:04.406374
...
describe('转账', () => {
  ...
  beforeAll(async () => {
    ...
    const wdaPort = Number(process.env.WDA_PORT) || 63489;
  ...
  it('转账', async () => {
    ...
    // Step 1: 启动 (id: step_step_step_step_step_step_step_step_1770278333135)
    console.log("[Step 1] 启动");
    await agent.launch('com.esurfingpay.bestpay');
    await sleep(2000);

    // Step 2: 点击 (id: step_1770285660904)
    console.log("[Step 2] 点击");
    await agent.aiTap('右下角我的tab');

    // Step 3: 点击 (id: step_1770285650772)
    console.log("[Step 3] 点击");
    await agent.aiTap('我的资产下方的余额文字');

    // Step 4: 点击 (id: step_1770285637462)
    console.log("[Step 4] 点击");
    await agent.aiTap('弹窗中的去绑卡');
  }, 720000);
});