...
// 用例: 转账
// 平台: iOS
// 生成时间: 2026-02-05T21:51:46.004061
...
describe('转账', () => {
  ...
  beforeAll(async () => {
    ...
    const wdaPort = Number(process.env.WDA_PORT) || 55841;
  ...
  it('转账', async () => {
    ...
    // Step 1: 启动 (id: step_step_step_step_step_step_step_step_step_1770278333135)
    console.log("[Step 1] 启动");
    await agent.launch('com.esurfingpay.bestpay');
    await sleep(2000);

    // Step 2: 点击 (id: step_1770299502294)
    console.log("[Step 2] 点击");
    await agent.aiTap('右下角tab我的');

    // Step 3: 点击 (id: step_1770299474427)
    console.log("[Step 3] 点击");
    await agent.aiTap('我的资产下方的余额');

    // Step 4: 检查 (id: step_1770299464188)
    console.log("[Step 4] 检查");
